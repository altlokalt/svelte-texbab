		...
		return (
			(function (s) {
				...
				for (var n = 0; n < s.length; n++)
					(t = l + ' ' + s[n]),
						e(t).val() ? (e(t).removeClass(c), (a = !0)) : (e(t).addClass(c), (a = !1));
			})(u),
			e(d).val() &&
			e(d)
				.val()
		...
		(e.fn.sectionPosition = function (t, a) {
			e(this).each(function () {
				...
				(s = Math.floor(l.height() / 2)),
					...
					'top-half' === n
						? (e(o).css('padding-bottom', r + s + 'px'), l.css('margin-top', '-' + s + 'px'))
						: 'bottom-half' === n &&
						  (e(o).css('padding-top', i + s + 'px'), l.css('margin-bottom', '-' + s + 'px'));
			});
		});
				...
				(s = c.attr(t)),
					...
					'margin-top' === s
						? (e(n).css('padding-bottom', l + m(o) + 'px'),
						  c.css('margin-top', '-' + m(o) + 'px').css({ position: 'relative', 'z-index': '3' }))
						: 'margin-bottom' === s &&
				...
				if (
					(s.on('click', function (t) {
						...
						s.addClass('active').siblings().removeClass('active'),
							a.sliderTab ? e(o).slick('slickGoTo', s.data('slide-go-to')) : r();
					}),
					a.sliderTab)
				) {
