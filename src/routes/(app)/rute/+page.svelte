<script lang="ts">
	...
	const markerData = [
		{
			id: 1,
			latLng: [51.50370009926, 7.483969975241],
			price: 20,
			more: 'This is the cheapest option'
		},
		{
			id: 2,
			latLng: [51.503770648001, 7.45339928381087],
			price: 80,
			more: 'This is very expensive'
		},
		{
			id: 3,
			latLng: [51.5038242276231707, 7.477535019824],
			price: 40,
			more: 'This a middle price not cheap nor expensive'
		},
		{
			id: 4,
			latLng: [51.50382427638138, 7.463396045511974],
			price: 0,
			more: 'This price is not valid'
		}
				...
				<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="64" height="64">
					<circle
						...
						style="fill:{data.price === 0
							...
							: data.price <= 50
							? 'red'
							: 'white'};stroke:gray;stroke-width:0.1"
					/>
				</svg>
