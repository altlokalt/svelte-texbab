<script>
  ...
  <div class='flex items-center justify-center min-h-screen from-gray-130 via-gray-30 to-gray-50 bg-gradient-to-br'>
    <h2>Spill</h2>
    {#each [0, 1, 2] as reel}
      <div class="relative w-1/3 h-screen" key={reel}>
