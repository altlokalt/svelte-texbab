<div
	id="slider"
	class="ls-wp-container fitvidsignore hero-3 th-hero-carousel"
	style="width:1720px;height:850px;max-width:1720px;margin:0 auto;margin-bottom: 0px;"
>
	<!-- assets/img/hero/hero_bg_3_2.png 483 assets/img/hero/hero_text_2.png-->
	<div class="ls-slide" data-ls="duration:7000; transition2d:114; kenburnsscale:1.2;">
		<img
			width="1720"
			height="850"
			src="{import.meta.env
				.VITE_PB_URL}/api/files/n4sfebjxm43jxvc/m4lzlv02n5le8w5/about_banner_YBp3hhV4Aw.jpg?token="
			class="ls-bg"
			alt="hero img"
		/>
		<img
		...
		<img
			...
			height="154"
			src="{import.meta.env
				.VITE_PB_URL}/api/files/n4sfebjxm43jxvc/7ogu48n5lu9scd2/delivery_icon_nbSSvELwQW.png?token="
			class="ls-l ls-img-layer"
			alt="hero img"
		...
		<img
			width="85"
			height="122"
			src="assets/img/hero/hero_shape_9.png"
			class="ls-l ls-img-layer"
			alt="hero img"
			...
			data-ls="offsetxin:40; offsetyin:40; durationin:1300; scalexin:0.7; scaleyin:0.7; transformoriginin:100% 100% 0; loop:true; loopduration:555; loopscalex:1.2; loopscaley:1.2; looptransformorigin:100KR 100% 0; loopcount:-1; loopyoyo:true;"
		/>
		<img
			width="69"
			height="115"
			src="assets/img/hero/hero_shape_10.png"
			class="ls-l ls-img-layer"
			alt="hero img"
			...
			data-ls="offsetxin:-40; offsetyin:-40; durationin:1300; scalexin:0.7; scaleyin:0.7; transformoriginin:0 100% 100%; bgcolorin:transparent; colorin:transparent; loop:true; loopduration:555; loopscalex:1.2; loopscaley:1.2; looptransformorigin:100KR 100% 0; loopcount:-1; loopyoyo:true;"
		/>
		<img
			width="265"
			height="178"
			src="assets/img/hero/discount_1.png"
			class="ls-l ls-img-layer"
			alt="hero img"
	...
	<div class="ls-slide" data-ls="duration:7000; transition2d:114; kenburnsscale:1.2;">
		<img
			...
			height="850"
			src="{import.meta.env
				.VITE_PB_URL}/api/files/n4sfebjxm43jxvc/qfk5pyqlvbq06uu/badge_2_bg_p14zy6_v78h_KQUopUMErC.png?token="
			class="ls-bg"
			alt="hero img"
		/>
		<a
			class="ls-l ls-hide-phone"
			href="https://www.texbab.com/menu/texbab_fullmenu"
			target="_self"
			...
			><img
				width="150"
				height="77"
				src="assets/img/hero/button_2.png"
				class="ls-img-layer"
				alt="hero img"
			...
			width="127"
			height="50"
			src="assets/img/hero/curve_line_2.png"
			class="ls-l ls-img-layer"
			alt="hero img"
		...
		<img
			width="589"
			height="489"
			src="assets/img/hero/hero_shape_11.png"
			class="ls-l ls-img-layer"
			alt="hero img"
		...
		<img
			width="543"
			height="438"
			src="assets/img/hero/hero_text_3.png"
			class="ls-l ls-img-layer"
			alt="hero img"
...
-->
	<div class="ls-slide" data-ls="duration:7000; transition2d:114; kenburnsscale:1.2;">
		<img
			...
			height="850"
			src="{import.meta.env
				.VITE_PB_URL}/api/files/n4sfebjxm43jxvc/7n018r6q3tw2az7/hero_slider_3_lhr4ZhzBhy.png?token="
			class="ls-bg"
			alt="hero img"
		/>
		<img
		...
		<img
			width="153"
			height="152"
			src="assets/img/hero/shape_bg_1.png"
		...
		><img
			width="126"
			height="50"
			src="assets/img/hero/curve_line_1.png"
			class="ls-l ls-img-layer"
			alt="hero img"
		...
		<a
			...
			><img
				width="99"
				height="58"
				src="assets/img/hero/button_1.png"
				class="ls-img-layer"
				alt="hero img"
		...
		><a
			...
			><ls-layer
				...
				class="ls-button-layer icon-btn"><i class="far fa-arrow-right" /></ls-layer
			></a
		><a
			class="ls-l"
			href="#prev"
			...
			><ls-layer
				...
				class="ls-button-layer icon-btn"><i class="far fa-arrow-left" /></ls-layer
			></a
		>
	</div>
</div>
